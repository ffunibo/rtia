...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Lavori a Roskilde DK</xsl:variable>
    <xsl:variable name="DocFileName">lavoriaroskildecomhtml</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">428</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1024</xsl:variable>
    <xsl:variable name="ZoomImageHeight">548</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.78125</xsl:variable>
    <xsl:variable name="ScaledImageFileName">lavoriaroskildecomhtml_wv_img1.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">lavoriaroskildecomhtml_wv_zoom_img1.jpg</xsl:variable>
